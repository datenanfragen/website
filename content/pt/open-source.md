...
<article class="list-article icon-list-article">
    ...
    <a class="button button-primary read-more-button" href="https://github.com/datenanfragen/website">Ver repositório&nbsp;</a>
</article>

<article class="list-article icon-list-article">
    <div class="col25 article-featured-image"><img class="image" src="/card-icons/database.svg" alt="data" style="width: 70%;"></div>
    <div class="padded col75">
        <a class="no-link-decoration" href="https://github.com/datenanfragen/data">dados</a><br>
    ...
    <div class="clearfix"></div>
    <a class="button button-primary read-more-button" href="https://github.com/datenanfragen/data">Ver repositório&nbsp;</a>
</article>
...
<article class="list-article icon-list-article">
    ...
    <div class="clearfix"></div>
    <a class="button button-primary read-more-button" href="https://github.com/datenanfragen/media">Ver repositório&nbsp;</a>
</article>

<article class="list-article icon-list-article">
    <div class="col25 article-featured-image"><img class="image" src="/card-icons/letter.svg" alt="letter-generator"></div>
    <div class="padded col75">
        <a class="no-link-decoration" href="https://github.com/datenanfragen/letter-generator">letter-generator (Gerador de Carta)</a><br>
        <span class="license">Licença MIT</span>
        <p class="description">
    ...
    <div class="clearfix"></div>
    <a class="button button-primary read-more-button" href="https://github.com/datenanfragen/letter-generator">Ver repositório&nbsp;</a>
</article>
...
<article class="list-article icon-list-article">
    ...
    <div class="clearfix"></div>
    <a class="button button-primary read-more-button" href="https://github.com/datenanfragen/verein">Ver repositório&nbsp;</a>
</article>
...
<article class="list-article icon-list-article">
    ...
    <div class="clearfix"></div>
    <a class="button button-primary read-more-button" href="https://github.com/zner0L/postcss-fonticons">Ver repositório&nbsp;</a>
</article>
...
<article class="list-article icon-list-article">
    ...
    <div class="clearfix"></div>
    <a class="button button-primary read-more-button" href="https://github.com/datenanfragen/backend">Ver repositório&nbsp;</a>
</article>
