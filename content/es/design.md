{
    "title": "Guía de diseño y estilo",
    "type": "design-guide",
    "date": "2019-09-29T14:42:25+02:00",
    "last_edited": "2021-01-25T14:42:25+02:00",
    "authors": [ "baltpeter" ]
}
...
Hemos definido una paleta de colores principal y una extendida. Combinadas con negro puro y blanco puro, estas dos paletas componen la selección concluyente de colores utilizados para Datenanfragen.de. No se pueden utilizar otros colores (ni siquiera para ilustraciones).

Para mayor comodidad, la paleta de colores está disponible como [Adobe Swatch Exchange (ASE) file](/downloads/datenanfragen.ase) y como [Adobe Creative Cloud library](https://shared-assets.adobe.com/link/4a911d28-c227-4821-475f-4c7efe2039d1).

### Paleta principal

La paleta principal consta de nuestro color primario (azul) y nuestro color de acento (verde azulado), cada uno en nueve tonos diferentes.
...
La paleta extendida se toma del gran [Tailwind CSS](https://tailwindcss.com/docs/customizing-colors/#default-color-palette).
