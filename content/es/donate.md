...
* **¿Cómo puedo donar de forma anónima?**
    ...
    *Datenanfragen.de e.&thinsp;V.  
    ...
    Para donaciones en efectivo, sugerimos utilizar el servicio postal alemán [EINSCHREIBEN Wert](https://www.deutschepost.de/de/e/einschreiben/kuendigung-abo-themen/geld-verschicken.html) o un producto similar ofrecido por tu oficina de correos local. No recomendamos enviar donaciones en efectivo a nivel internacional. En cualquier caso, asegúrate de que el contenido de tu carta no sea visible desde el exterior.
