{
	...
	"heading": "<span style='text-align: center; font-family: monospace;'>datarequests.org <span style='color: #d8000c;' title='loves'>❤</span> Open Source</span>"
}

<img id="open-source-humaaan" class="top-left-humaaan" style="margin-top: -70px;" src="/img/humaaans/open-source.svg">

Open Source is at the very core of datarequests.org. We have designed the project from the ground up to be as open as possible. Our [constitution](https://verein.datenanfragen.de/en/constitution/) requires us to publish our content under free licenses.
