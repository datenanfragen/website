...
Für die Antwort hat das DRK Brandenburg einen Monat Zeit. Danach darfst Du Dich bei einer {{< link slug="blog/supervisory-authorities" text="Datenschutz-Aufsichtsbehörde" >}} beschweren. Sollte es dazu kommen, können wir Dir auch dabei helfen, wie wir in dem {{< link slug="blog/supervisory-authorities" text="entsprechenden Artikel" >}} erklären.
