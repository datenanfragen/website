...
<table id="guv-table" class="table fancy-table fancy-table-mobile">
  ...
  <tfoot>
    ...
    <tr class="bg-blue-700 color-white">
        <th scope="row" class="align-right"><strong>Gesamt Gewinn/Verlust</strong></th>
