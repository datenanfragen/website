...
<div class="form-group"><input type="checkbox" id="accept_terms" name="accept_terms" class="form-element" required><label for="accept_terms"><div class="float-left" style="width: 90%;">Die <a href="https://static.dacdn.de/docs/bedingungen-hacktoberfest-2021.pdf">Teilnahmebedingungen und Datenschutzerklärung</a> habe ich zur Kenntnis genommen. Ich bin mit den Bedingungen und der Verarbeitung meiner Daten für diese Hacktoberfest-Aktion einverstanden.<sup class="color-teal-700">*</sup></div></label></div>
