...
## Naši repozitoriji otvorenog koda

Ovdje se nalazi pregleda važnih repozitorija koja smo stvorili (što izravno ili neizravno) za datarequests.org. Oni se naravno objavljuju pod slobodnim licencama. Pozivamo te da baciš pogled iza kulisa, da doprineseš ili da iskoristiš naš rad za vlastite projekte! Rado primamo prijave grešaka i zahtjeve za preuzimanje putem repozitorija.
...
<article class="list-article icon-list-article">
    ...
    <div class="padded col75">
        ...
        <p class="description">
            ...
            <br>Web-stranica je prvenstveno statična te koristi Hugo i Preact.
        </p>
    </div>
    <div class="clearfix"></div>
    <a class="button button-primary read-more-button" href="https://github.com/datenanfragen/website">Otvori repozitorij&nbsp;<span class="icon icon-arrow-right"></span></a>
</article>
...
<article class="list-article icon-list-article">
    ...
    <div class="padded col75">
        ...
        <p class="description">
            ...
            <br>Repozitorij je strukturiran kao zbirka tekstualnih datoteka u običnom i u strojno čitljivom formatu.
        </p>
    </div>
    <div class="clearfix"></div>
    <a class="button button-primary read-more-button" href="https://github.com/datenanfragen/data">Otvori repozitorij&nbsp;<span class="icon icon-arrow-right"></span></a>
</article>
...
<article class="list-article icon-list-article">
    ...
    <div class="clearfix"></div>
    <a class="button button-primary read-more-button" href="https://github.com/datenanfragen/media">Otvori repozitorij&nbsp;<span class="icon icon-arrow-right"></span></a>
</article>
...
<article class="list-article icon-list-article">
    ...
    <div class="clearfix"></div>
    <a class="button button-primary read-more-button" href="https://github.com/datenanfragen/letter-generator">Otvori repozitorij&nbsp;<span class="icon icon-arrow-right"></span></a>
</article>
...
<article class="list-article icon-list-article">
    ...
    <div class="clearfix"></div>
    <a class="button button-primary read-more-button" href="https://github.com/datenanfragen/verein">Otvori repozitorij&nbsp;<span class="icon icon-arrow-right"></span></a>
</article>
...
<article class="list-article icon-list-article">
    ...
    <div class="padded col75">
        ...
        <p class="description">
            ...
            <br>Prilagođeno na osnovi dodatka od Jan Nicklasa <a href="https://github.com/jantimon/iconfont-webpack-plugin">Icon Font Webpack Plugin</a>.
        </p>
    </div>
    <div class="clearfix"></div>
    <a class="button button-primary read-more-button" href="https://github.com/zner0L/postcss-fonticons">Otvori repozitorij&nbsp;<span class="icon icon-arrow-right"></span></a>
</article>
...
<article class="list-article icon-list-article">
    ...
    <div class="clearfix"></div>
    <a class="button button-primary read-more-button" href="https://github.com/datenanfragen/backend">Otvori repozitorij&nbsp;<span class="icon icon-arrow-right"></span></a>
</article>
...
U skladu s duhom otvorenog koda, ne samo da održavamo vlastite projekte otvorenog koda, već i uveliko koristimo druge projekte otvorenog koda u našem projektu.

Ponosni smo što možemo koristiti sljedeće projekte za ovu web-stranicu. Zahvaljujemo svim autorima koji su odlučili dijeliti svoj rad s drugima!
