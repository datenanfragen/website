...
const steps: Record<string, Steps> = {
    country: {
        ...
        de: {
            ...
            rundfunk: {
                // Source: https://www.mdr.de/rundfunkdatenschutz/ueber-uns/aufgaben/aufgaben-100.html
                'rundfunk-br': 'derf',
                'rundfunk-dw': 'derfdw',
                'rundfunk-dr': 'derf',
                'rundfunk-hr': 'derf',
                ...
                'rundfunk-wdr': 'derf',
                'rundfunk-zdf': 'derf',
                // Source: https://www.rundfunkbeitrag.de/datenschutz/datenschutzrechtliche-aufsichtsbehoerde
                'rundfunk-beitragsservice': 'derf',
            },
        },
        gr: 'grdpa',
        hu: 'hunaih',
