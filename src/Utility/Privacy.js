...
export default class Privacy {
    ...
    static dntEnabled() {
        return navigator.doNotTrack == '1' || window.doNotTrack == '1' || navigator.doNotTrack == 'yes' || navigator.msDoNotTrack == 1 || (window.external && ((!!window.external.msTrackingProtectionEnabled && typeof window.external.msTrackingProtectionEnabled == 'function' && window.external.msTrackingProtectionEnabled()) || (!!window.external.InPrivateFilteringEnabled && typeof window.external.InPrivateFilteringEnabled == 'function' && window.external.InPrivateFilteringEnabled())));
    }
